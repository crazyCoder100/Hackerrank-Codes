...
Each value should be space-padded to match the width of the binary value of i.
...
def print_formatted(number):
    ...
    for i in list(range(1,number+1)):
        print(' '.join(map(lambda x:x.rjust(max_len),[str(i),oct(i)[2:],hex(i)[2:].upper(),bin(i)[2:]])))
